...
public class Thread implements Runnable {
    ...
    Runnable target;
    private static int count = 0; 		//count 静态域，属于类，只有一份拷贝

    /**
     * Holds the thread's ID. We simply count upwards, so
     * each Thread has a unique ID.
     */
    private long id;		//普通的实例域，每一个对象都有自己的一份拷贝
    ...
    /**
     * Returns the name of the Thread.返回线程的名字
     */
